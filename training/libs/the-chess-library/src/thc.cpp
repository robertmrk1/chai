...
std::vector<double> ChessPosition::ToVector() {
    const char *p = squares;
    for (int i = 0; i < 64; ++i) {
        char c = *p++;
        if (c == ' ') {
            position_vector[i] = 0.0;
        } else if (c == 'P') {
            position_vector[i] = 1.0;
        } else if (c == 'N') {
            position_vector[i] = 2.0;
        } else if (c == 'B') {
            position_vector[i] = 3.0;
        } else if (c == 'R') {
            position_vector[i] = 4.0;    
        } else if (c == 'Q') {
            position_vector[i] = 5.0; 
        } else if (c == 'K') {
            position_vector[i] = 6.0; 
        } else if (c == 'p') {
            position_vector[i] = -1.0;
        } else if (c == 'n') {
            position_vector[i] = -2.0;
...
bool ChessRules::IsJustDraw() {
    // Insufficient mating material
    if (IsJustInsufficientDraw()) {
        return true;
    }
...
bool ChessRules::IsJustInsufficientDraw() {
    char   piece;
    int    piece_count=0;
    bool   bishop_or_knight=false, lone_wking=true, lone_bking=true;
    bool   draw=false;
