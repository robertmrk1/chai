...
namespace de
{
    ...
    public:
        ...
        DifferentialEvolution(  const IOptimizable& costFunction,
                                ...
                                int randomSeed = 123,
                                bool shouldCheckConstraints = false,
        ...
        void Optimize(int iterations, bool verbose = true)
        {
            ...
            for (int i = 0; i < iterations; i++)
            {
                ...
                if (verbose)
                {
                    ...
                    std::cout << "Iteration: " << i <<"    Current minimal cost: " << m_minCost << "\n";
            ...
            std::vector<double> best_agent_end = m_population[m_bestAgentIndex];
            std::ofstream out_file("ai_params.txt");
            for (double param : best_agent_end) {
                out_file << std::to_string(param) + "\n";
            }
    ...
    private:
        ...
        static constexpr double g_defaultLowerConstraint = -1;
        static constexpr double g_defaultUpperConstarint = 1;
    };
}
